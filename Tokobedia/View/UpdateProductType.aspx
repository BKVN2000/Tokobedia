<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site.Master" AutoEventWireup="true" CodeBehind="UpdateProductType.aspx.cs" Inherits="Tokobedia.View.UpdateProductType" %>
    ...
    <div>
        ...
        <asp:HiddenField id="HdnProductTypeId" runat="server"/>
         <div class="form-group">
            ...
            <asp:RequiredFieldValidator runat="server" ControlToValidate="DescTxt"></asp:RequiredFieldValidator>
          </div>

        <asp:Button runat="server" class="btn btn-primary text-uppercase" OnClick="Btn_SubmitProductTypeID" Text="submit"/>
    </div>
</asp:Content>
